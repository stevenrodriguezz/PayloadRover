...
// Both functions that are called are derived from the BNO.h and BME.h header files and start reading their corrresponding sensors data when called, update to their current time plus the delay period. 
  if (millis()>BNOTime){
    BNO_READ();
